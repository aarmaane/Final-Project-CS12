...
// Subclass of the Enemy class and creates Crystal enemies that fall due to gravity and injure the player
...
public class Crystal extends Enemy {
    ...
    private boolean hitPlayer, falling; // Movement flags

    // Initializes the class by loading the crystal sprite
